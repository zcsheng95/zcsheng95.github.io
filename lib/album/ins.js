    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          ...
          var minSrc = 'https://raw.githubusercontent.com/zcsheng95/Myphotos/master/min_photos/' + data.link[i];

         // var src = 'https://raw.githubusercontent.com/yourgithub/Blog_Album/master/photos/' + data.link[i];
          var src = 'https://raw.githubusercontent.com/zcsheng95/Myphotos/master/photos/' + data.link[i];
        ...
        ulTmpl = ulTmpl + '<section class="archives album"><h1 class="year">' + data.year +  '<em>' + months[data.month-1]+ '</em></h1>\
        <ul class="img-box-ul">'+ liTmpl + '</ul></section>';
